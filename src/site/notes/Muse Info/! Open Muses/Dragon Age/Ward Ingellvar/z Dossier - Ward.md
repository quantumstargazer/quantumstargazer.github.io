...
- *name:* Ward Ingellvar 
- *nickname:* Ghost
- *alias:* Ghost of the Necropolis
	- Rook (*verse dependant*)
- *gender:* Agender 
...
- *place of birth:* ***~~The Fade~~*** Grand Necropolis - Nevarra
...
- *fighting style:* Staff
	- Orb & Spellblade Dagger
## Current Status
- *current moral alignment:* Chaotic Good
- *current role(s):* —
- *current location(s):* Grand Necropolis - Nevarra
- *current residence(s):* Grand Necropolis - Nevarra
- *current vehicle(s):* — 
- *current situation status:* —
- *current conditions:* Victim of Blood Magic (*Solas connection*)
