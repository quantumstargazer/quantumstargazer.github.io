---
{"dg-publish":true,"permalink":"/rulebook-old/rules-details/fandom-specific-rules/baldur-s-gate-rules/","tags":["rules","rules-fandom-specific","baldurs-gate"],"dg-note-properties":{"tags":["rules","rules-fandom-specific","baldurs-gate"],"aliases":["Baldur's Gate","Baldur's Gate - Rules"]}}
---
...
> [!rule]+ Baldur's Gate Worldstate Conditions
> **I will *not* write in worldstates that utilize the following conditions — these are non-negotiable:**
> - Astarion Ancunín is not recruited.
> - Astarion Ancunín is driven away from camp.
> - Astarion Ancunín is killed. (*Only exception is at the monastery, assuming he's revived.*)
> 
> 
