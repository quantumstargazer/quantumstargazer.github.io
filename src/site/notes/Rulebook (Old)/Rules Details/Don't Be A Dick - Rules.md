---
{"dg-publish":true,"permalink":"/rulebook-old/rules-details/don-t-be-a-dick-rules/","tags":["rules"],"dg-note-properties":{"tags":["rules"],"aliases":["Don't Be A Dick"]}}
---
...
> 
> **Intentional misgendering will lead to you being blocked.** Muses' pronouns can be found on the rosters, in their individual summaries, on nearly every page of their further information, *and* on the [[Quick Reference\|Quick Reference]] page that is set up specifically to cover the most basic info typically needed for threads and memes. There is *no excuse* for not knowing each muse's pronouns.
