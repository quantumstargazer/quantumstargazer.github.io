---
{"dg-publish":true,"permalink":"/rulebook-old/rules-details/blacklist-tags-rules/","tags":["rules","guidelines","blacklist"],"dg-note-properties":{"tags":["rules","guidelines","blacklist"],"aliases":["Blacklist Tags","Blacklist Tagging"]}}
---
...
| abortion (*incl. being denied one*)                       | **yes** — *if tagged*                                   |              **yes** — *if tagged*              |
...
However, I do rely on the mobile app as well, so please tag posts with this aesthetic with any of the following tags — they're all blacklisted, so whatever is easiest for you to remember is fine.

| blacklisted tags to use     |
| --------------------------- |
| eye strain cw               |
| migraine trigger cw         |
| ziggy don't look            |
| lexi don't look             |
| quantumstargazer don't look |
| lefae don't look            |
